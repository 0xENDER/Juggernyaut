...
if(NOT TARGET mimalloc)
    ...
    set(MIMALLOC_REDIRECT_LIB_PATH "$<TARGET_FILE_DIR:mimalloc>/mimalloc-redirect$<TARGET_FILE_SUFFIX:mimalloc>" CACHE STRING "mimalloc redirect shared library path" FORCE)
endif()
