...
function(manage_symbolic_links POST_TARGET JUG_COMMAND_NAME)
    if(WIN32)
        set(SYMBOLIC_LINKS_COMMAND_DELETE start /wait powershell -Command "Remove-Item -Path ./${JUG_COMMAND_NAME}.exe -Force -ErrorAction Ignore")
        ...
        set(SYMBOLIC_LINKS_COMMAND_DELETE rm -f ${JUG_COMMAND_NAME})
