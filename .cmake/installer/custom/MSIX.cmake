...
set(MSIX_INTERNAL_RUNTIME_FOLDER ${CMAKE_INSTALL_SYSTEM_RUNTIME_DESTINATION})
set(MSIX_INTERNAL_BIN "${CPACK_TEMPORARY_DIRECTORY}/${MSIX_INTERNAL_RUNTIME_FOLDER}")
...
foreach(INDEX RANGE ${MSIX_INTERNAL_APPLICATIONS_LAST_INDEX})
    ...
    if(APP_TYPE STREQUAL "ALIAS")
        ...
        set(MSIX_INTERNAL_MANIFEST_APPLICATIONS "${MSIX_INTERNAL_MANIFEST_APPLICATIONS}    <Application
                Id=\"TARGET_ALIAS_${CURRENT_TARGET}\" Executable=\"${MSIX_INTERNAL_RUNTIME_FOLDER}\\${CURRENT_TARGET}.exe\"
